...
class Task extends JPanel {
    ...
    Color orange = new Color(255, 178, 102);
    Color green = new Color(188, 226, 158);
    Color doneColor = new Color(133, 51, 9);
    //    Color doneColor = new Color(133, 51, 9);
    private boolean checked;

    Task() {
        this.setPreferredSize(new Dimension(400, 20)); // set size of task
        this.setBackground(orange); // set background color of task
        ...
        taskName = new JTextField("Add Your List:   "); // create task name text field
        taskName.setBorder(BorderFactory.createEmptyBorder()); // remove border of text field
        taskName.setBackground(orange); // set background color of text field
...
class List extends JPanel {
    ...
    Color lightColor = new Color(204, 204, 229);
...
class TitleBar extends JPanel {
    ...
    Color lightColor = new Color(160, 160,160);
